...
*/
object InitialJedRedisCommunityDriver {
...
//小区初始化，构造成CommunityID，CommunityDetail
    ...
    getAllBargains.foreachPartition{iter => {
      ...
      iter.foreach{
        line =>{
          ...
          pipe.hset(BARGAINSLOAD,communityID,bargainDetail)
...
//    val communityDetailMap = j.hgetAll("COMMUNITYINIT")
//    println("size:"+communityDetailMap.size())
  // JedisUtils.close(j)
  }
}
