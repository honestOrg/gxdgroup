...
object OneDataFunctionVerson2 {
  ...
  def main(args: Array[String]) {
    ...
    val indexListByRedis = j.lrange("北京", 0, -1)
    //下面是从redis中取Threadhold
          ...
          if (psimilarVal != null) {
            psimilarVal.split(",").filter {
              x =>
                ...
                (
                  Math.abs((array42Fields(1).toDouble - communityDetail(1).toDouble)) <= BigDecimal(threadTarget.SoilRank) &&
                    Math.abs((array42Fields(2).toDouble - communityDetail(2).toDouble)) <= BigDecimal(threadTarget.BusCount) &&
                    Math.abs((array42Fields(3).toDouble - communityDetail(3).toDouble)) <= BigDecimal(threadTarget.Park) &&
                    Math.abs((array42Fields(4).toDouble - communityDetail(4).toDouble)) <= BigDecimal(threadTarget.Amenities) &&
                    Math.abs((array42Fields(5).toDouble - communityDetail(5).toDouble)) <= BigDecimal(threadTarget.TrafficControl) &&
                    Math.abs((array42Fields(6).toDouble - communityDetail(6).toDouble)) <= BigDecimal(threadTarget.GoodFactor) &&
                    Math.abs((array42Fields(7).toDouble - communityDetail(7).toDouble)) <= BigDecimal(threadTarget.BadFactor) &&
                    Math.abs((array42Fields(8).toDouble - communityDetail(8).toDouble)) <= BigDecimal(threadTarget.Scope) &&
                    Math.abs((array42Fields(9).toDouble - communityDetail(9).toDouble)) <= BigDecimal(threadTarget.BuildYear) &&
                    Math.abs((array42Fields(10).toDouble - communityDetail(10).toDouble)) <= BigDecimal(threadTarget.Heating) &&
                    Math.abs((array42Fields(11).toDouble - communityDetail(11).toDouble)) <= BigDecimal(threadTarget.IsSchool) &&
                    Math.abs((array42Fields(12).toDouble - communityDetail(12).toDouble)) <= BigDecimal(threadTarget.Style) &&
                    Math.abs((array42Fields(13).toDouble - communityDetail(13).toDouble)) <= BigDecimal(threadTarget.PropertyLevel) &&
                    Math.abs((array42Fields(14).toDouble - communityDetail(14).toDouble)) <= BigDecimal(threadTarget.Environment) &&
                    Math.abs((array42Fields(15).toDouble - communityDetail(15).toDouble)) <= BigDecimal(threadTarget.Density) &&
                    Math.abs((array42Fields(16).toDouble - communityDetail(16).toDouble)) <= BigDecimal(threadTarget.Far) &&
                    Math.abs((array42Fields(17).toDouble - communityDetail(17).toDouble)) <= BigDecimal(threadTarget.DistanceFromCenter) &&
                    Math.abs((array42Fields(18).toDouble - communityDetail(18).toDouble)) <= BigDecimal(threadTarget.DistanceFromTrading) &&
                    Math.abs((array42Fields(19).toDouble - communityDetail(19).toDouble)) <= BigDecimal(threadTarget.DistanceFromLandScape)
                  )
            }.map {
              line =>
    ...
    // val  beijingIndexList = indexListByRedis
  ...
  def GetSimilarCommunity2(GetAllCommunity: Array[String],
    ...
    GetAllCommunity.map(line => {
      ...
      (arraysFields(0).toString, AVMUtils.GetDistance(pLatitude, pLongitude,
        arraysFields(5).toDouble, arraysFields(4).toDouble))
  ...
  def mapCalculateModel(bargainList: Seq[Bargain], thresholds: Threshold, settingBroadcast: Map[String, Setting], pcommunityName: String, pfloor: Int, pTotalFloor: Int, psquare: Double, pfaceTo: String, pbuildYear: String,
