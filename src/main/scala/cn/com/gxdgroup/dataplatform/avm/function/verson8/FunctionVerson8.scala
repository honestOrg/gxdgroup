package cn.com.gxdgroup.dataplatform.avm.function.verson8
...
import cn.com.gxdgroup.dataplatform.avm.model.AVMBargain2
import cn.com.gxdgroup.dataplatform.avm.model.Bargain2
...
import cn.com.gxdgroup.dataplatform.avm.model.Result2
...
import java.util
/**
 * Created by ThinkPad on 14-7-4.
 */
object FunctionVerson8 {
  ...
  def main(args: Array[String]) {
    ...
    */
    ...
    val lgfinal = AlotOFBargainList.map{line =>
    ...
    val one = "lg/gxd/yanshi_one/"+args(2)
    println("one:"+one)
    lg2.saveAsTextFile(one)
    ...
    //val two  = "hdfs://cloud40:8020/user/gxd/lg/gxd/yanshi_two/"+args(2)
  //  println("two:"+two)
    //lg3.saveAsTextFile(two)
