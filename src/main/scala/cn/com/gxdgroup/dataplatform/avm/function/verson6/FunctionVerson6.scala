//package cn.com.gxdgroup.dataplatform.avm.function.verson6
//
...
//    //*******************
//    val rdd2 = sc.parallelize(List(("A",1),("B",2),("C",3),("A",1),("B",5)))
//
//
////    JedisUtils.initPool
...
//       val secondToBargainList = new ListBuffer[(Double,Bargain2,BigDecimal)]
//
...
//
//              val SimilarCommunity  = new ListBuffer[(String,Double)]
//
...
//                  SimilarCommunity += (arraysFields(0)->distance)
//                }
//              }
//              SimilarCommunity.toList
//            // case true => List()
//            case false =>
...
//                  secondToBargainList ++=  mapCalculateModel(bargainList2, threadTarget, setting,
